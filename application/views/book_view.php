...
<td>
<button class="btn btn-warning" onclick="edit_book(<?php echo

$book->book_id;?>)"><i class="glyphicon glyphicon-pencil"></i></button>

<button class="btn btn-danger" onclick="delete_book(<?php echo

$book->book_id;?>)"><i class="glyphicon glyphicon-remove"></i></button>
...
<input name="book_isbn" placeholder="Book ISBN" class="form-
control" type="text">
...
<input name="book_title" placeholder="Book_title" class="form-
control" type="text">
...
<input name="book_category" placeholder="Book Category" class="form-
control" type="text">
